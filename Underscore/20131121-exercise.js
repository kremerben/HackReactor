...
return destination;
  ...
  _.memoize = function(func) {
    ...
    //var prop = func.prototype.apply(this,args);
  var result;
  return function() {
...
return func;
  ...
  //try returning arguments, see if anytihng shows up?
...
if (args.length>0) {
  ...
  return setTimeout(func(argsArray),wait);
}
  ...
  _.flatten = function(nestedArray, result) {
    ...
    _.map(nestedArray, function(num) {
      result.push(num);
    });
  };
    return result;
