...
// if doesn't exist - create and store
  ...
  _.delay = function(func, wait) {
    //need to bring back args as we're passing them through to a second function)
   ...
   */
   // creates an array from 1 to topNumber
  ...
  _.shuffle = function(obj) {
    ...
    while (objCopy.length > 0) {
      shuffled.push(objCopy.splice((Math.floor(Math.random() * objCopy.length)),1));
    }
